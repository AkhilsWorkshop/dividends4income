...
export const Hero = () => {
    return (
        <div className="container mx-auto text-center max-w-2xl text-primary pt-[50px] lg:pt-[150px] pb-10 space-y-10">

            <h1 className="text-3xl lg:text-6xl font-bold text-balance">
