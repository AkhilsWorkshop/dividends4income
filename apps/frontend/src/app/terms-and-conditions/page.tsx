...
export const metadata: Metadata = {
    title: 'Terms & Conditions - Dividends4Income',
    description: 'Terms and Conditions for Dividends4Income dividend investing platform.',
}
                ...
                <div className="lg:bg-layer lg:rounded-lg p-4 lg:p-6 lg:shadow-sm text-sm">
                    ...
                    <div className="prose prose-invert max-w-none">
                        ...
                        <p className="text-secondary leading-relaxed mb-6">
                            By accessing and using Dividends4Income (&ldquo;the Service&rdquo;), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
                        </p>
