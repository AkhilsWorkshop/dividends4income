                ...
                <div className="lg:bg-layer lg:rounded-lg p-4 lg:p-6 lg:shadow-sm text-sm">
                    ...
                    <div className="prose prose-invert max-w-none">
                        ...
                        <p className="text-secondary leading-relaxed mb-6">
                            Dividends4Income (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our dividend investing platform (the &ldquo;Service&rdquo;).
                        </p>
                        ...
                        <p className="text-secondary leading-relaxed mb-6">
                            We may update this Privacy Policy from time to time. We will notify users of material changes by updating the &ldquo;Last Updated&rdquo; date.
                        </p>
