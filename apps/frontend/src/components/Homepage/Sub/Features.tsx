                ...
                {features?.slice(0, 3)?.map((feature, index) =>
                    ...
                    <div key={index} className="bg-layer/50 rounded-xl border border-border shadow-sm p-4 overflow-hidden">
                        ...
                        <div className="overflow-hidden border border-border rounded-md">
                            ...
                            <img src={`${feature.url}.png`} alt={feature.title} className="block dark:hidden w-full h-full object-cover rounded-md aspect-square" />
                            <img src={`${feature.url}-dark.png`} alt={feature.title} className="hidden dark:block w-full h-full object-cover rounded-md aspect-square" />
                ...
                {features?.slice(3, 5)?.map((feature, index) =>
                    ...
                    <div key={index} className="bg-layer/50 rounded-xl border border-border shadow-sm p-4 overflow-hidden">
                        ...
                        <div className="overflow-hidden border border-border rounded-md">
                            ...
                            <img src={`${feature.url}.png`} alt={feature.title} className="block dark:hidden w-full h-full object-cover rounded-md aspect-video" />
                            <img src={`${feature.url}-dark.png`} alt={feature.title} className="hidden dark:block w-full h-full object-cover rounded-md aspect-video" />
