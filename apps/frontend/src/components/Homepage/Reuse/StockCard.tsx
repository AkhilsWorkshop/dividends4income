...
export const StockCard = ({ stock }: StockCardProps) => {
    return (
        <Link href={`/stock/${stock.symbol}`} className="group hover:shadow-md transition-shadow cursor-pointer bg-layer p-6 rounded-xl border border-border shadow-sm space-y-6 text-primary block">
