export const Footer = () => {
    ...
    return (
        <footer className="bg-layer/50 border-t border-border/50">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <nav className="space-y-2">
                            ...
                            <a href="/#features" className="block text-secondary hover:text-primary transition-colors duration-200 text-sm">
                                Features
                            </a>

                            <a href="/#how-it-works" className="block text-secondary hover:text-primary transition-colors duration-200 text-sm">
                                How It Works
                            </a>

                            <a href="/#popular-stocks" className="block text-secondary hover:text-primary transition-colors duration-200 text-sm">
                                Popular Stocks
                            </a>

                            <a href="/#faq" className="block text-secondary hover:text-primary transition-colors duration-200 text-sm">
                                FAQ
                            </a>
                    ...
                    <div className="space-y-4">
                        ...
                        <nav className="space-y-2">
                            ...
                            <a
                                href="mailto:reachme@akhilkumar.dev"
